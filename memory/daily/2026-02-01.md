...
3. **Configured local embeddings:**
   ...
   ```
4. **Renamed folder** - `memories/` → `memory/` for Clawdbot consistency
...
**Triggers:**
- After completing a task → summarize in daily log
- Learning something reusable → add to topics/
- Project milestone → update projects/
- Person context learned → update people/
