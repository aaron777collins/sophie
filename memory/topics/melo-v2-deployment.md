...
4. Rsync'd to dev2: `rsync -avz --delete .next/standalone/ dev2:/home/ubuntu/repos/melo-v2-new/.next/standalone/`
5. Restarted PM2: `pm2 restart melo-v2 --update-env`
...
## Git Status
- **Repository:** ~/repos/melo-v2
- **Remote (aaron):** https://github.com/aaron777collins/melo.git
