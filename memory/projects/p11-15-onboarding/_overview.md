...
## Task Description
Implement new user onboarding flow with tutorial and feature introduction for HAOS v2.
...
- ✅ Analyzed existing HAOS v2 codebase structure
...
- ✅ **OnboardingModal Component** (`components/onboarding/onboarding-modal.tsx`)
  ...
  - Integration with existing HAOS UI patterns
...
- ✅ **Tutorial Settings Page** (`app/(main)/(routes)/settings/tutorial/page.tsx`)
  ...
  - Help resources and HAOS information
...
## Notes
- Implementation follows existing HAOS UI patterns and conventions
