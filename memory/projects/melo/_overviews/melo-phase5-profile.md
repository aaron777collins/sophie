# Project Overview: melo-phase5-profile
...
## Files Changed
- apps/web/src/components/melo/UserProfileModal.tsx — NEW: Full Discord-style user profile modal
- apps/web/src/components/melo/ProfileEditModal.tsx — NEW: Profile editing modal
- apps/web/res/css/melo/components/_profile-edit.pcss — NEW: CSS for profile edit modal
- apps/web/res/css/melo/index.pcss — Added import for _profile-edit.pcss

## Dependencies Discovered
- CSS already exists: `apps/web/res/css/melo/components/_user-profile.pcss` (comprehensive!)
- Uses mediaFromMxc for proper media handling
- Uses UIStore for viewport dimensions
- Stores profile data in Matrix account data (io.melo.user_profile)
- Stores user notes in Matrix account data (io.melo.user_notes)
- Gets roles from io.melo.member_roles state event
