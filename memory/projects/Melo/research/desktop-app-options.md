# Desktop App Options for MELO v2

**Research Date:** 2026-02-16  
**Context:** Converting MELO v2 (Next.js 14 + React 18 + TypeScript chat app with Matrix SDK) to native desktop apps

---

## Executive Summary

For MELO v2, **Tauri is the recommended approach** due to its small bundle size, native performance, and straightforward Next.js integration. However, **enhancing the existing PWA** should be the first step since MELO already has a service worker and this requires the least effort.
...
### How It Works
MELO already has a service worker foundation. Desktop PWA support lets users "install" the web app via Chrome or Edge, creating a standalone window that behaves like a native app.
...
### Implementation for MELO
Since MELO already has a service worker, enhancements needed:
...
const CACHE_NAME = 'melo-v2-cache';
...
- **Already partially implemented** in MELO
...
**Not recommended for MELO** because:
...
### Effort Estimate
- **Not recommended for MELO**

---

## Recommended Approach for MELO
...
## Required Changes to MELO Codebase
...
**For MELO v2, the recommended path is:**
