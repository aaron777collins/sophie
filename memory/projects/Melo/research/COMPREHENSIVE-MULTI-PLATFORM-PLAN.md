# MELO v2 Multi-Platform Strategy

**Date:** 2026-02-16  
**Author:** Sophie (synthesized from research agents)  
**Goal:** Convert MELO web app to desktop + mobile with minimal code rewrite and full offline support
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    MELO Multi-Platform Architecture                  │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│                        ┌─────────────────┐                          │
│                        │   MELO Web App  │                          │
...
|------|--------|------------|
| **Tauri requires static export** | No SSR/API routes | MELO uses Matrix SDK (client-side), minimal impact |
