# MELO v2 Mobile App Options Analysis

**Research Date:** 2026-02-16  
**Researcher:** Research Agent (subagent)  
**Context:** MELO v2 is a Next.js 14 + React 18 + TypeScript chat app using Matrix SDK with existing PWA service worker support.
...
For MELO v2's goal of "minimal code rewrite," Capacitor is the clear winner. It wraps your existing Next.js web app in native shells, provides access to native APIs through plugins, and allows App Store deployment—all without rewriting your React codebase.
...
**MELO-Specific Consideration:** Since MELO uses Matrix SDK for real-time messaging (client-side WebSocket), this works perfectly with Capacitor. No API routes needed—Matrix handles everything.

### Native Plugin Ecosystem

**Official Plugins (maintained by Ionic):**
| Plugin | Purpose | MELO Relevance |
|--------|---------|----------------|
...
### Capacitor Integration Steps for MELO

```bash
# 1. Install Capacitor
npm install @capacitor/core
npm install -D @capacitor/cli
npx cap init "MELO" "com.melo.app"
...
### Current PWA Status in MELO
MELO v2 already has service worker support for PWA. This provides:
...
| MELO Component | Rewrite Needed | Effort |
|----------------|----------------|--------|
...
### Tauri Verdict for MELO

**Not recommended currently** for MELO because:
...
**For MELO v2, use Capacitor** because it:
...
4. **Has mature ecosystem** - Official plugins for everything MELO needs
...
|------|--------|------------|
| Next.js SSR features don't work | Low | MELO doesn't rely on SSR for Matrix |
...
*Analysis complete. Capacitor is the clear winner for MELO v2's mobile strategy given the goal of minimal code rewrite while gaining native app capabilities.*
