...
# Also patch _setup_providers
from MachineLearning.DaskPipelineRunner import DaskPipelineRunner

original_setup = DaskPipelineRunner._setup_providers
setup_count = [0]

def patched_setup(self):
    setup_count[0] += 1
    print(f"[DEBUG] _setup_providers called #{setup_count[0]} for pipeline {self.pipeline_name}")
    original_setup(self)

DaskPipelineRunner._setup_providers = patched_setup
