# MELO Full Validation Plan

> Created: 2026-02-10 09:15 EST
> Goal: Validate every aspect of MELO is perfect, beautiful, matches Discord, and fix anything missing
...
1. **Deploy Phase** - Get latest MELO on dev2
...
### A-001: Build Latest MELO
- Build the webapp on dev3
- Verify no build errors
- Status: in-progress

### A-002: Deploy to dev2
- Copy built webapp to dev2:/home/ubuntu/melo-webapp/
- Restart nginx container to pick up changes
- Verify accessible at https://melo.dev2.aaroncollins.info
...
- Note: Element container IS serving MELO, don't stop it
- Just ensure only MELO is served, not original Element
