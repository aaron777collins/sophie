# Task 07: movement_2km_withid_const
...
| Property | Value |
|----------|-------|
| **Pipeline Name** | movement_2km_withid_const |
| **Config File** | `production_configs_v2/movement_2km_withid_const_pipeline_config.json` |
| **Run Script** | `production_configs_v2/Run2kmMovementWithIdConst.py` |
| **Radius** | 2km |
| **Feature Set** | Movement (6 features) |
| **Vehicle ID** | Yes |
...
# Execute pipeline
python production_configs_v2/Run2kmMovementWithIdConst.py 2>&1 | tee logs/movement_2km_withid_const_$(date +%Y%m%d_%H%M%S).log
```

### Step 2: Log Audit

```bash
LOG=$(ls -t logs/movement_2km_withid_const_*.log | head -1)

echo "=========================================="
echo "LOG AUDIT: movement_2km_withid_const"
echo "Log file: $LOG"
echo "=========================================="
...
ls -la results/matrix/movement_2km_withid_const/
# EXPECTED: CSV files with ML results

# Check cache created
ls -la cache/matrix/movement_2km_withid_const/
...
- [ ] ML accuracy > 65%
- [ ] Results files created in results/matrix/movement_2km_withid_const/
- [ ] Cache files created
...
3. Proceed to Task 08 (unless this is Task 36)
