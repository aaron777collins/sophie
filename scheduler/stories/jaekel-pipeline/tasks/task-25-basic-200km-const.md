...
| Property | Value |
|----------|-------|
| **Pipeline Name** | basic_200km_const |
| **Config File** | `production_configs_v2/basic_200km_const_pipeline_config.json` |
...
# Execute pipeline
python production_configs_v2/Run200kmBasicConst.py 2>&1 | tee logs/basic_200km_const_$(date +%Y%m%d_%H%M%S).log
```

### Step 2: Log Audit

```bash
LOG=$(ls -t logs/basic_200km_const_*.log | head -1)

echo "=========================================="
echo "LOG AUDIT: basic_200km_const"
echo "Log file: $LOG"
echo "=========================================="
...
ls -la results/matrix/basic_200km_const/
# EXPECTED: CSV files with ML results

# Check cache created
ls -la cache/matrix/basic_200km_const/
...
- [ ] ML accuracy > 65%
- [ ] Results files created in results/matrix/basic_200km_const/
- [ ] Cache files created
...
3. Proceed to Task 26 (unless this is Task 36)
