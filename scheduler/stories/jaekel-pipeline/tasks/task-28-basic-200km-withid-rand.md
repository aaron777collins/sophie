# Task 28: basic_200km_withid_rand
...
| Property | Value |
|----------|-------|
| **Pipeline Name** | basic_200km_withid_rand |
| **Config File** | `production_configs_v2/basic_200km_withid_rand_pipeline_config.json` |
| **Run Script** | `production_configs_v2/Run200kmBasicWithIdRand.py` |
| **Radius** | 200km |
...
# Execute pipeline
python production_configs_v2/Run200kmBasicWithIdRand.py 2>&1 | tee logs/basic_200km_withid_rand_$(date +%Y%m%d_%H%M%S).log
```

### Step 2: Log Audit

```bash
LOG=$(ls -t logs/basic_200km_withid_rand_*.log | head -1)

echo "=========================================="
echo "LOG AUDIT: basic_200km_withid_rand"
echo "Log file: $LOG"
echo "=========================================="
...
ls -la results/matrix/basic_200km_withid_rand/
# EXPECTED: CSV files with ML results

# Check cache created
ls -la cache/matrix/basic_200km_withid_rand/
...
- [ ] ML accuracy > 65%
- [ ] Results files created in results/matrix/basic_200km_withid_rand/
- [ ] Cache files created
...
3. Proceed to Task 29 (unless this is Task 36)
