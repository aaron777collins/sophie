# Coordinator Notes: MELO v2

**Last Updated:** 2026-02-13 10:00 EST

## Project Overview

MELO v2 is a Discord-styled Matrix client. Self-hosted, federation enabled (invite-only by default), video rooms with all the goodies.
...
- **Task Breakdown:** `~/clawd/docs/melo-v2/TASK-BREAKDOWN.md`
- **Project Memory:** `~/clawd/memory/projects/melo-v2/_overview.md`
