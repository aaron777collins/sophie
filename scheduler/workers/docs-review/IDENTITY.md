...
- Verify and update feature list in documentation
- Clarify current stability/maturity level
- Remove deprecated features
- Add any new configuration or deployment notes
...
- Create a PR-style changeset
- Summarize key documentation updates