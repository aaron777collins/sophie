...
## Task
**Task:** Fix Next.js build errors in MELO v2
...
### Evidence
- Files modified:
  - `/home/ubuntu/repos/melo-v2/app/api/og-preview/route.ts` - Added dynamic export
  - `/home/ubuntu/repos/melo-v2/app/offline/page.tsx` - Refactored to server component
  - `/home/ubuntu/repos/melo-v2/app/offline/offline-page-client.tsx` - New client component (created)
...
- **Files created/modified:** 
  - `/home/ubuntu/repos/melo-v2/app/api/og-preview/route.ts` - Added `export const dynamic = 'force-dynamic'`
  - `/home/ubuntu/repos/melo-v2/app/offline/page.tsx` - Refactored to server component with metadata exports
  - `/home/ubuntu/repos/melo-v2/app/offline/offline-page-client.tsx` - New client component with event handlers
- **Build output:** ✓ Compiled successfully, ✓ Generating static pages (28/28)
- **Git commit:** f85e15f "fix: resolve Next.js build errors"

### Verification Steps for Task Manager
1. Check files exist: `ls -la ~/repos/melo-v2/app/api/og-preview/route.ts ~/repos/melo-v2/app/offline/`
2. Verify dynamic export: `grep "export const dynamic" ~/repos/melo-v2/app/api/og-preview/route.ts`
3. Run build: `cd ~/repos/melo-v2 && pnpm build` (should complete successfully)
4. Check commit: `cd ~/repos/melo-v2 && git log --oneline -1` (should show f85e15f)
