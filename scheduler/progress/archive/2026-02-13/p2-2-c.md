...
- [14:35] Found: ServerSection component already exists at `/home/ubuntu/repos/haos-v2/components/server/server-section.tsx`
...
- [✅] localStorage keys use format: `haos-collapse-{serverId}-{sectionType}-{channelType}`
