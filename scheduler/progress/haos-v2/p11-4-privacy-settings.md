...
### Evidence
- Files created/modified:
  * `/home/ubuntu/repos/haos-v2/lib/matrix/privacy.ts` - 318 lines, comprehensive privacy utilities
  * `/home/ubuntu/repos/haos-v2/hooks/use-privacy-settings.ts` - 312 lines, React hooks with optimistic updates
  * `/home/ubuntu/repos/haos-v2/components/privacy/blocked-users-list.tsx` - 263 lines, blocked users management UI
  * `/home/ubuntu/repos/haos-v2/components/privacy/user-search-block.tsx` - 387 lines, user search and blocking
  * `/home/ubuntu/repos/haos-v2/app/(main)/(routes)/settings/privacy/page.tsx` - 269 lines, enhanced settings page
...
1. Check files exist: `ls -la /home/ubuntu/repos/haos-v2/lib/matrix/privacy.ts /home/ubuntu/repos/haos-v2/hooks/use-privacy-settings.ts /home/ubuntu/repos/haos-v2/components/privacy/`
2. Run build: `cd /home/ubuntu/repos/haos-v2 && npm run build`
