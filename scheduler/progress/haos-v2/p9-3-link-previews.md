...
## Task Overview
Implement OpenGraph link previews for messages with URLs in HAOS v2.
...
- Read AGENTS.md and HAOS v2 project overview
- Located project at ~/repos/haos-v2 with mature Matrix chat system
...
- All components properly integrated into existing HAOS architecture
