...
**Task:** Create comprehensive user onboarding flow for new MELO users with multi-step wizard and interactive tutorials.
...
2. **`components/onboarding/steps/welcome-step.tsx`** (6.8KB) 
   - Welcoming introduction to MELO and Matrix
...
1. **Welcome (Step 1)**: Introduction to MELO with feature overview and expectations setting
