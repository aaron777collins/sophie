# LiveKit Integration Audit for HAOS v2
...
| Area | Discord Clone | HAOS v2 Change |
|------|---------------|----------------|
...
**Options:**
1. **Keep both** - Discord clone pattern for HAOS, JWT service for Element Call (recommended)
...
Add to `/home/ubuntu/repos/haos-v2/.env`:
```bash
...
2. **Custom Theme** - Create `data-lk-theme="haos"`:
```tsx
<LiveKitRoom data-lk-theme="haos">
```
...
| NPM Packages | ✅ Ready | Already in haos-v2 |
