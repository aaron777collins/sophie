...
This document breaks down the MELO v2 implementation into **atomic, actionable, testable tasks**. Each task has:
...
- **Files to Create:**
  ...
  ```
- **Success Criteria:**
  - Can import from `@melo/shared` in apps/web
...
- **Files to Create:**
  ```
  docs/melo-v2/DEV-SETUP.md (Matrix section)
  ```
- **Actions:**
...
- **Actions:**
  - Create `@alice:melo.local`, `@bob:melo.local`, `@admin:melo.local`
...
- **Files to Create:**
  ```
  docs/melo-v2/DEV-SETUP.md (LiveKit section)
  ```
- **Actions:**
...
- **Files to Create:**
  ```
  docs/melo-v2/DISCORD-CLONE-INVENTORY.md
  ```
- **Success Criteria:**
  - Every component listed with purpose
  - Dependencies documented

#### p0-4-c: Copy UI Components to MELO
...
#### p0-4-d: Copy Feature Components to MELO
...
- **Implementation Notes:**
  - Use custom state event `io.melo.invite`
