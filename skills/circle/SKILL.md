...
**Situation:** Human asks "What time is it?"
...
**Situation:** Human seems frustrated about a bug. Should I offer to help debug or give him space?
...
SITUATION: Human seems frustrated about a bug. He just said "ugh, this keeps breaking"
...
```bash
# Quick light check
claude -p "$(cat ~/workspace/skills/circle/prompts/light.txt | sed 's/{situation}/Human wants to refactor auth/g')" --model haiku
