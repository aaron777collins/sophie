---
name: memory-system
description: "The hierarchical memory system for recording and retrieving context across daily logs, projects, topics, and people. Use when working with memories, needing past context, or recording new information."
---

# Memory System Skill v2

This workspace uses a **self-scaling hierarchical memory system** in `memory/` for persistent context.
...
```markdown
## Key Points
- [2026-02-01 16:15 EST] Human requested memory system upgrade with auto-scaling
